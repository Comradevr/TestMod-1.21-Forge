package net.spaxe.testmod.block.custom;

import net.spaxe.testmod.item.ModItems;
...
public class MagicBlock extends Block {
    ...
    public void stepOn(Level pLevel, BlockPos pPos, BlockState pState, Entity pEntity) {
        if(pEntity instanceof ItemEntity itemEntity) {
            ...
            if(itemEntity.getItem().getItem() == Items.SLIME_BLOCK) {
                itemEntity.setItem(new ItemStack(Items.HONEY_BLOCK, itemEntity.getItem().getCount()));
            }
        }
